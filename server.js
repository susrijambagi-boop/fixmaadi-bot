...
const SERVICES_EN = {
    '1': { name: 'Home Repair 🔧', price: 'from ₹79', subcategories: ['Plumbing', 'Electrical Wiring', 'Mixie & Appliance Repair', 'Carpentry', 'Painting', 'AC Repair & Service', 'RO / Water Purifier Repair', 'TV & Electronics Repair', 'Furniture Assembly', 'Pest Control', 'TV Mounting', 'Door & Window Repair', 'CCTV Installation'], keywords: ['plumber', 'plumbing', 'pipe', 'tap', 'leak', 'electrician', 'electrical', 'wiring', 'wire', 'mcb', 'fuse', 'light', 'mixie', 'appliance', 'carpenter', 'carpentry', 'wood', 'door', 'window repair', 'lock', 'table', 'paint', 'painting', 'civil', 'mason', 'wall', 'ac repair', 'ac service', 'air conditioner', 'ro repair', 'water purifier', 'tv repair', 'tv mounting', 'electronics repair', 'furniture assembly', 'pest control', 'termite', 'cockroach', 'cctv', '1'] },
    '2': { name: 'Personal Care ✂️', price: 'from ₹149', subcategories: ['Beautician', "Men's Haircut & Grooming", 'Bridal Makeup', 'Mehendi Artist', 'Massage Therapist', 'Spa at Home', 'Facial & Skincare', 'Manicure & Pedicure', 'Hair Styling', 'Waxing', 'Threading', 'Tattoo Artist'], keywords: ['beautician', 'beauty', 'salon', 'facial', 'skincare', 'parlour', 'haircut', 'barber', 'grooming', 'beard', 'bridal makeup', 'makeup', 'mehendi', 'henna', 'massage', 'spa', 'manicure', 'pedicure', 'hair styling', 'waxing', 'threading', 'tattoo', '2'] },
    '3': { name: 'Health & Wellness 🩺', price: 'from ₹299', subcategories: ['Home Nurse', 'Physiotherapist', 'Elderly Care Attendant', 'Baby Care / Nanny', 'Yoga Instructor', 'Diet Consultant', 'Personal Trainer', 'Lab Sample Collection', 'Ayurvedic Therapist', 'Medical Equipment Rental', 'Post-Surgery Care', 'Mental Health Counselor'], keywords: ['nurse', 'nursing', 'physiotherapist', 'physio', 'elderly care', 'attendant', 'baby care', 'nanny', 'babysitter', 'yoga', 'diet', 'nutrition', 'dietician', 'personal trainer', 'lab sample', 'ayurvedic', 'medical equipment', 'post-surgery', 'post surgery', 'mental health', 'counselor', 'counsellor', '3'] },
    '4': { name: 'Transport & Roadside 🚗', price: 'from ₹99', subcategories: ['Driver on Call', 'Jump Start', 'Puncture Repair', 'Bike / Car Wash', 'Towing Assistance', 'Car & Bike Servicing', 'Vehicle Inspection', 'Packers & Movers (Vehicle)', 'Driving Instructor', 'Fuel Delivery', 'Key / Lock Unlock'], keywords: ['driver', 'jump start', 'battery', 'puncture', 'tyre', 'tire', 'bike wash', 'car wash', 'towing', 'tow', 'car service', 'bike service', 'vehicle inspection', 'packers and movers', 'driving instructor', 'fuel delivery', 'lock unlock', 'key unlock', '4'] },
    '5': { name: 'Labour & Cleaning 🧹', price: 'from ₹299', subcategories: ['Loading / Unloading Labour', 'House Shifting', 'Gardening', 'Deep Cleaning', 'Sofa & Carpet Cleaning', 'Water Tank Cleaning', 'Septic Tank Cleaning', 'Bathroom Deep Cleaning', 'Kitchen Deep Cleaning', 'Office Cleaning', 'Facade & Glass Cleaning', 'Disinfection Service'], keywords: ['loading', 'unloading', 'labour', 'labor', 'shifting', 'house shifting', 'gardening', 'garden', 'deep cleaning', 'sofa cleaning', 'carpet cleaning', 'water tank', 'sump', 'septic', 'drain', 'bathroom cleaning', 'kitchen cleaning', 'office cleaning', 'glass cleaning', 'facade cleaning', 'disinfection', 'sanitization', '5'] },
    '6': { name: 'Events 🎉', price: 'from ₹501', subcategories: ['Purohit & Pujas', 'Stage Decoration', 'Catering Labour', 'DJ & Sound', 'Photography', 'Videography', 'Event Planning & Coordination', 'Tent & Furniture Rental', 'Anchor / Emcee', 'Live Music Band', 'Return Gift Arrangement'], keywords: ['purohit', 'puja', 'pooja', 'pandit', 'stage', 'decoration', 'balloon', 'flower', 'catering', 'cook', 'cooking', 'chef', 'dj', 'sound system', 'photography', 'photographer', 'videography', 'event planning', 'event management', 'tent house', 'anchor', 'emcee', 'live band', 'return gift', '6'] },
    '7': { name: 'Education 📚', price: 'from ₹499/mo', subcategories: ['Home Tutors', 'Music Teacher', 'Dance Teacher', 'Art & Craft Teacher', 'Spoken English Trainer', 'Computer / Coding Tutor', 'Competitive Exam Coaching', 'Abacus / Vedic Maths', 'Karate / Self-Defense Instructor', 'Yoga for Kids', 'Language Teacher'], keywords: ['tutor', 'tuition', 'teacher', 'class', 'music teacher', 'dance teacher', 'art teacher', 'craft teacher', 'spoken english', 'coding tutor', 'computer tutor', 'exam coaching', 'abacus', 'vedic maths', 'karate', 'self defense', 'kids yoga', 'language teacher', '7'] },
    '8': { name: 'Pet Care 🐾', price: 'from ₹299', subcategories: ['Pet Grooming', 'Dog Walking', 'Veterinary Home Visit', 'Pet Boarding', 'Pet Training', 'Pet Sitting', 'Aquarium Cleaning', 'Pet Taxi', 'Pet Food Delivery', 'Pet Vaccination Assistance'], keywords: ['pet grooming', 'dog walking', 'pet', 'dog', 'cat', 'veterinary', 'vet visit', 'pet boarding', 'pet training', 'pet sitting', 'aquarium', 'pet taxi', 'pet food delivery', 'pet vaccination', '8'] },
    '9': { name: 'Others (Not Listed) 📞', price: 'call for details', subcategories: [], keywords: ['other', 'others', 'else', 'different', '9'] }
};

const SERVICES_KN = {
    '1': { name: 'ಮನೆ ರಿಪೇರಿ 🔧', price: '₹79 ರಿಂದ', subcategories: ['ಪ್ಲಂಬಿಂಗ್', 'ವಿದ್ಯುತ್ ವೈರಿಂಗ್', 'ಮಿಕ್ಸಿ & ಉಪಕರಣ ರಿಪೇರಿ', 'ಬಡಗಿ ಕೆಲಸ', 'ಪೇಂಟಿಂಗ್', 'ಎಸಿ ರಿಪೇರಿ & ಸರ್ವಿಸ್', 'ವಾಟರ್ ಪ್ಯೂರಿಫೈಯರ್ ರಿಪೇರಿ', 'ಟಿವಿ & ಎಲೆಕ್ಟ್ರಾನಿಕ್ಸ್ ರಿಪೇರಿ', 'ಪೀಠೋಪಕರಣ ಜೋಡಣೆ', 'ಕೀಟ ನಿಯಂತ್ರಣ', 'ಟಿವಿ ಮೌಂಟಿಂಗ್', 'ಬಾಗಿಲು & ಕಿಟಕಿ ರಿಪೇರಿ', 'ಸಿಸಿಟಿವಿ ಅಳವಡಿಕೆ'], keywords: ['ಪ್ಲಂಬರ್', 'ಪ್ಲಂಬಿಂಗ್', 'ನೀರ', 'ನಲ್ಲಿ', 'ಎಲೆಕ್ಟ್ರಿಷಿಯನ್', 'ವೈರಿಂಗ್', 'ಲೈಟ್', 'ವೈರ್', 'ಮಿಕ್ಸಿ', 'ಫ್ಯಾನ್', 'ಕಾರ್ಪೆಂಟರ್', 'ಮರಗೆಲಸ', 'ಬಡಗಿ', 'ಬಾಗಿಲು', 'ಕಿಟಕಿ', 'ಪೇಂಟಿಂಗ್', 'ಗಾರೆ', 'ಬಣ್ಣ', 'ಎಸಿ', 'ವಾಟರ್ ಪ್ಯೂರಿಫೈಯರ್', 'ಟಿವಿ ರಿಪೇರಿ', 'ಟಿವಿ ಮೌಂಟಿಂಗ್', 'ಪೀಠೋಪಕರಣ', 'ಕೀಟ ನಿಯಂತ್ರಣ', 'ಸಿಸಿಟಿವಿ', '1'] },
    '2': { name: 'ವೈಯಕ್ತಿಕ ಆರೈಕೆ ✂️', price: '₹149 ರಿಂದ', subcategories: ['ಬ್ಯೂಟಿಷಿಯನ್', 'ಪುರುಷರ ಹೇರ್‌ಕಟ್ & ಗ್ರೂಮಿಂಗ್', 'ಬ್ರೈಡಲ್ ಮೇಕಪ್', 'ಮೆಹೆಂದಿ ಕಲಾವಿದೆ', 'ಮಸಾಜ್ ಥೆರಪಿಸ್ಟ್', 'ಮನೆಯಲ್ಲಿ ಸ್ಪಾ', 'ಫೇಶಿಯಲ್ & ಸ್ಕಿನ್‌ಕೇರ್', 'ಮ್ಯಾನಿಕ್ಯೂರ್ & ಪೆಡಿಕ್ಯೂರ್', 'ಹೇರ್ ಸ್ಟೈಲಿಂಗ್', 'ವ್ಯಾಕ್ಸಿಂಗ್', 'ಥ್ರೆಡಿಂಗ್', 'ಟ್ಯಾಟೂ ಕಲಾವಿದ'], keywords: ['ಬ್ಯೂಟಿಷಿಯನ್', 'ಪಾರ್ಲರ್', 'ಫೇಶಿಯಲ್', 'ಹೇರ್‌ಕಟ್', 'ಕ್ಷೌರ', 'ಬಾರ್ಬರ್', 'ಬ್ರೈಡಲ್ ಮೇಕಪ್', 'ಮೆಹೆಂದಿ', 'ಮಸಾಜ್', 'ಸ್ಪಾ', 'ಮ್ಯಾನಿಕ್ಯೂರ್', 'ಪೆಡಿಕ್ಯೂರ್', 'ಹೇರ್ ಸ್ಟೈಲಿಂಗ್', 'ವ್ಯಾಕ್ಸಿಂಗ್', 'ಥ್ರೆಡಿಂಗ್', 'ಟ್ಯಾಟೂ', '2'] },
    '3': { name: 'ಆರೋಗ್ಯ 🩺', price: '₹299 ರಿಂದ', subcategories: ['ಮನೆ ದಾದಿ', 'ಫಿಸಿಯೋಥೆರಪಿಸ್ಟ್', 'ವೃದ್ಧರ ಆರೈಕೆ', 'ಮಗುವಿನ ಆರೈಕೆ', 'ಯೋಗ ಬೋಧಕರು', 'ಆಹಾರ ಸಲಹೆಗಾರರು', 'ಪರ್ಸನಲ್ ಟ್ರೈನರ್', 'ಲ್ಯಾಬ್ ಸ್ಯಾಂಪಲ್ ಸಂಗ್ರಹ', 'ಆಯುರ್ವೇದಿಕ್ ಥೆರಪಿಸ್ಟ್', 'ವೈದ್ಯಕೀಯ ಉಪಕರಣ ಬಾಡಿಗೆ', 'ಶಸ್ತ್ರಚಿಕಿತ್ಸೆ ನಂತರದ ಆರೈಕೆ', 'ಮಾನಸಿಕ ಆರೋಗ್ಯ ಸಲಹೆಗಾರರು'], keywords: ['ದಾದಿ', 'ಫಿಸಿಯೋಥೆರಪಿ', 'ವೃದ್ಧರ ಆರೈಕೆ', 'ಮಗುವಿನ ಆರೈಕೆ', 'ಯೋಗ', 'ಆಹಾರ ಸಲಹೆ', 'ಪರ್ಸನಲ್ ಟ್ರೈನರ್', 'ಲ್ಯಾಬ್ ಸ್ಯಾಂಪಲ್', 'ಆಯುರ್ವೇದಿಕ್', 'ವೈದ್ಯಕೀಯ ಉಪಕರಣ', 'ಶಸ್ತ್ರಚಿಕಿತ್ಸೆ', 'ಮಾನಸಿಕ ಆರೋಗ್ಯ', '3'] },
    '4': { name: 'ಸಾರಿಗೆ 🚗', price: '₹99 ರಿಂದ', subcategories: ['ಡ್ರೈವರ್', 'ಜಂಪ್ ಸ್ಟಾರ್ಟ್', 'ಪಂಕ್ಚರ್ ರಿಪೇರಿ', 'ಬೈಕ್/ಕಾರ್ ವಾಶ್', 'ಟೋಯಿಂಗ್ ಸಹಾಯ', 'ಕಾರ್ & ಬೈಕ್ ಸರ್ವಿಸಿಂಗ್', 'ವಾಹನ ತಪಾಸಣೆ', 'ಪ್ಯಾಕರ್ಸ್ & ಮೂವರ್ಸ್', 'ಡ್ರೈವಿಂಗ್ ಬೋಧಕರು', 'ಇಂಧನ ಡೆಲಿವರಿ', 'ಕೀ/ಲಾಕ್ ಅನ್‌ಲಾಕ್'], keywords: ['ಡ್ರೈವರ್', 'ಜಂಪ್ ಸ್ಟಾರ್ಟ್', 'ಪಂಕ್ಚರ್', 'ಬೈಕ್ ವಾಶ್', 'ಕಾರ್ ವಾಶ್', 'ಟೋಯಿಂಗ್', 'ಕಾರ್ ಸರ್ವಿಸ್', 'ಬೈಕ್ ಸರ್ವಿಸ್', 'ವಾಹನ ತಪಾಸಣೆ', 'ಪ್ಯಾಕರ್ಸ್', 'ಡ್ರೈವಿಂಗ್ ಬೋಧಕರು', 'ಇಂಧನ ಡೆಲಿವರಿ', 'ಲಾಕ್ ಅನ್‌ಲಾಕ್', '4'] },
    '5': { name: 'ಕಾರ್ಮಿಕ & ಕ್ಲೀನಿಂಗ್ 🧹', price: '₹299 ರಿಂದ', subcategories: ['ಲೋಡಿಂಗ್/ಅನ್‌ಲೋಡಿಂಗ್ ಕಾರ್ಮಿಕರು', 'ಮನೆ ಶಿಫ್ಟಿಂಗ್', 'ತೋಟಗಾರಿಕೆ', 'ಡೀಪ್ ಕ್ಲೀನಿಂಗ್', 'ಸೋಫಾ & ಕಾರ್ಪೆಟ್ ಕ್ಲೀನಿಂಗ್', 'ನೀರಿನ ಟ್ಯಾಂಕ್ ಕ್ಲೀನಿಂಗ್', 'ಸೆಪ್ಟಿಕ್ ಟ್ಯಾಂಕ್ ಕ್ಲೀನಿಂಗ್', 'ಬಾತ್ರೂಮ್ ಡೀಪ್ ಕ್ಲೀನಿಂಗ್', 'ಕಿಚನ್ ಡೀಪ್ ಕ್ಲೀನಿಂಗ್', 'ಆಫೀಸ್ ಕ್ಲೀನಿಂಗ್', 'ಗಾಜು ಕ್ಲೀನಿಂಗ್', 'ಸೋಂಕು ನಿವಾರಣೆ ಸೇವೆ'], keywords: ['ಲೋಡಿಂಗ್', 'ಶಿಫ್ಟಿಂಗ್', 'ತೋಟಗಾರಿಕೆ', 'ಡೀಪ್ ಕ್ಲೀನಿಂಗ್', 'ಸೋಫಾ ಕ್ಲೀನಿಂಗ್', 'ನೀರಿನ ಟ್ಯಾಂಕ್', 'ಸೆಪ್ಟಿಕ್', 'ಸಂಪ್', 'ಬಾತ್ರೂಮ್ ಕ್ಲೀನಿಂಗ್', 'ಕಿಚನ್ ಕ್ಲೀನಿಂಗ್', 'ಆಫೀಸ್ ಕ್ಲೀನಿಂಗ್', 'ಗಾಜು ಕ್ಲೀನಿಂಗ್', 'ಸೋಂಕು ನಿವಾರಣೆ', '5'] },
    '6': { name: 'ಕಾರ್ಯಕ್ರಮಗಳು 🎉', price: '₹501 ರಿಂದ', subcategories: ['ಪುರೋಹಿತರು & ಪೂಜೆಗಳು', 'ವೇದಿಕೆ ಅಲಂಕಾರ', 'ಕ್ಯಾಟರಿಂಗ್ ಕಾರ್ಮಿಕರು', 'ಡಿಜೆ & ಸೌಂಡ್', 'ಫೋಟೋಗ್ರಫಿ', 'ವಿಡಿಯೋಗ್ರಫಿ', 'ಈವೆಂಟ್ ಯೋಜನೆ', 'ಟೆಂಟ್ & ಪೀಠೋಪಕರಣ ಬಾಡಿಗೆ', 'ಆಂಕರ್/ಎಂಸಿ', 'ಲೈವ್ ಮ್ಯೂಸಿಕ್ ಬ್ಯಾಂಡ್', 'ರಿಟರ್ನ್ ಗಿಫ್ಟ್ ವ್ಯವಸ್ಥೆ'], keywords: ['ಪುರೋಹಿತ', 'ಪೂಜೆ', 'ಪಂಡಿತ', 'ಅಲಂಕಾರ', 'ವೇದಿಕೆ', 'ಕ್ಯಾಟರಿಂಗ್', 'ಅಡುಗೆ', 'ಡಿಜೆ', 'ಫೋಟೋಗ್ರಫಿ', 'ವಿಡಿಯೋಗ್ರಫಿ', 'ಈವೆಂಟ್ ಯೋಜನೆ', 'ಟೆಂಟ್', 'ಆಂಕರ್', 'ಎಂಸಿ', 'ಮ್ಯೂಸಿಕ್ ಬ್ಯಾಂಡ್', 'ರಿಟರ್ನ್ ಗಿಫ್ಟ್', '6'] },
    '7': { name: 'ಶಿಕ್ಷಣ 📚', price: '₹499/ತಿಂಗಳಿಗೆ', subcategories: ['ಮನೆ ಪಾಠ', 'ಸಂಗೀತ ಶಿಕ್ಷಕರು', 'ನೃತ್ಯ ಶಿಕ್ಷಕರು', 'ಕಲೆ & ಕರಕುಶಲ ಶಿಕ್ಷಕರು', 'ಸ್ಪೋಕನ್ ಇಂಗ್ಲಿಷ್ ತರಬೇತುದಾರರು', 'ಕಂಪ್ಯೂಟರ್/ಕೋಡಿಂಗ್ ಟ್ಯೂಟರ್', 'ಸ್ಪರ್ಧಾತ್ಮಕ ಪರೀಕ್ಷಾ ತರಬೇತಿ', 'ಅಬಾಕಸ್/ವೇದಿಕ್ ಗಣಿತ', 'ಕರಾಟೆ/ಆತ್ಮರಕ್ಷಣಾ ಬೋಧಕರು', 'ಮಕ್ಕಳಿಗೆ ಯೋಗ', 'ಭಾಷಾ ಶಿಕ್ಷಕರು'], keywords: ['ಟ್ಯೂಷನ್', 'ಪಾಠ', 'ಶಿಕ್ಷಕರು', 'ಸಂಗೀತ ಶಿಕ್ಷಕ', 'ನೃತ್ಯ ಶಿಕ್ಷಕ', 'ಕಲೆ ಶಿಕ್ಷಕ', 'ಸ್ಪೋಕನ್ ಇಂಗ್ಲಿಷ್', 'ಕೋಡಿಂಗ್ ಟ್ಯೂಟರ್', 'ಕಂಪ್ಯೂಟರ್ ಟ್ಯೂಟರ್', 'ಪರೀಕ್ಷಾ ತರಬೇತಿ', 'ಅಬಾಕಸ್', 'ವೇದಿಕ್ ಗಣಿತ', 'ಕರಾಟೆ', 'ಆತ್ಮರಕ್ಷಣಾ', 'ಮಕ್ಕಳ ಯೋಗ', 'ಭಾಷಾ ಶಿಕ್ಷಕರು', '7'] },
    '8': { name: 'ಸಾಕುಪ್ರಾಣಿ ಆರೈಕೆ 🐾', price: '₹299 ರಿಂದ', subcategories: ['ಸಾಕುಪ್ರಾಣಿ ಗ್ರೂಮಿಂಗ್', 'ನಾಯಿ ವಾಕಿಂಗ್', 'ಪಶುವೈದ್ಯರ ಮನೆ ಭೇಟಿ', 'ಪೆಟ್ ಬೋರ್ಡಿಂಗ್', 'ಪೆಟ್ ತರಬೇತಿ', 'ಪೆಟ್ ಸಿಟ್ಟಿಂಗ್', 'ಅಕ್ವೇರಿಯಂ ಕ್ಲೀನಿಂಗ್', 'ಪೆಟ್ ಟ್ಯಾಕ್ಸಿ', 'ಪೆಟ್ ಆಹಾರ ಡೆಲಿವರಿ', 'ಪೆಟ್ ಲಸಿಕೆ ಸಹಾಯ'], keywords: ['ಸಾಕುಪ್ರಾಣಿ', 'ನಾಯಿ', 'ಗ್ರೂಮಿಂಗ್', 'ವಾಕಿಂಗ್', 'ಪಶುವೈದ್ಯ', 'ಪೆಟ್ ಬೋರ್ಡಿಂಗ್', 'ಪೆಟ್ ತರಬೇತಿ', 'ಪೆಟ್ ಸಿಟ್ಟಿಂಗ್', 'ಅಕ್ವೇರಿಯಂ', 'ಪೆಟ್ ಟ್ಯಾಕ್ಸಿ', 'ಪೆಟ್ ಆಹಾರ', 'ಪೆಟ್ ಲಸಿಕೆ', '8'] },
    '9': { name: 'ಇತರೆ (ಪಟ್ಟಿಯಲ್ಲಿ ಇಲ್ಲ) 📞', price: 'ಕರೆ ಮಾಡಿ ವಿವರ ಪಡೆಯಿರಿ', subcategories: [], keywords: ['ಇತರೆ', 'ಬೇರೆ', '9'] }
};
